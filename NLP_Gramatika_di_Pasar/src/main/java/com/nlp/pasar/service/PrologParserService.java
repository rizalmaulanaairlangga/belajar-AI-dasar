...
public class PrologParserService {
    ...
    private List<String> tokenize(String input) {
        // membersihkan input: lowercase dan hapus karakter non-alfanumerik
        ...
        // cek jika string kosong setelah dibersihkan
        if (cleaned.isEmpty()) {
            return List.of();
        }

        // split berdasarkan spasi dan masukkan ke daftar token
